...
class VehPass(object):
    ...
    _insertViolation = 'insert into veh_violation(sbbh, hphm, hpys, hpzl, lkbh, fxbh, cdbh, clsd, csys, cllx, filepath1, filepath2, filepath3, cjfs, jgsj, wfdz, shzt, hpzlid, wfddid, fxid, cdid, wfxw, wfxwid)' \
                       ' values (:sbbh, :hphm, :hpys, :hpzl, :lkbh, :fxbh, :cdbh, :clsd, :csys, :cllx, :filepath1, :filepath2, :filepath3, :cjfs, :jgsj, :wfdz, :shzt, :hpzlid, :wfddid, :fxid, :cdid, :wfxw, :wfxwid)'
